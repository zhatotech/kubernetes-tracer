...
class Periode extends CI_Controller {
	...
	public function index($rowno=0){
		...
		$data['title'] = 'Daftar periode '.$infopt->nama_info_pt;
		$data['menu'] = 'menu';
		...
		$data['detail'] = $getuser;
		$data['page'] = 'admin/periode/index-v';
		$search_text = "";
		if($post == TRUE ){
			$search_text = $post;
		...
		$allcount = $this->Periode_m->getrecordCount($search_text);
	    // Get records
		$users_record = $this->Periode_m->getData($rowno,$rowperpage,$search_text);
