<ul class="menu-nav">
	<li class="menu-item" aria-haspopup="true">
		<a href="<?php echo base_url('dashboard') ?>" class="menu-link">
			<span class="svg-icon menu-icon">
				<!--begin::Svg Icon | path:<?php echo base_url('assets/metronic_v7.1.8/theme/html/demo1/dist/') ?>assets/media/svg/icons/Design/Layers.svg-->
	...
	<li class="menu-section">
		<h4 class="menu-text">Perserta</h4>
	...
	<li class="menu-item" aria-haspopup="true">
		<a href="<?php echo base_url('tracer') ?>" class="menu-link">
			<span class="svg-icon menu-icon">
				<!--begin::Svg Icon | path:<?php echo base_url('assets/metronic_v7.1.8/theme/html/demo1/dist/') ?>assets/media/svg/icons/Design/Layers.svg-->
				<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
					<g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
			...
			<span class="menu-text">Tracer Studi</span>
		</a>
	</li>
	<li class="menu-item" aria-haspopup="true">
		<a href="<?php echo base_url('tracer') ?>" class="menu-link">
	...
	<li class="menu-item" aria-haspopup="true">
		<a href="<?php echo base_url('tahun') ?>" class="menu-link">
			<span class="svg-icon menu-icon">
				<!--begin::Svg Icon | path:<?php echo base_url('assets/metronic_v7.1.8/theme/html/demo1/dist/') ?>assets/media/svg/icons/Design/Layers.svg-->
				<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
					<g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
			...
			<span class="menu-text">Tahun</span>
		</a>
	</li>
</ul>