			...
			<div class="login-content flex-row-fluid d-flex flex-column justify-content-center position-relative overflow-hidden p-7 mx-auto">
				...
				<div class="d-flex flex-column-fluid flex-center">
					...
					<div class="login-form login-signin">
						<!--begin::Form-->
						<form action="<?php echo base_url('login/proseslogin/') ?>" class="form" novalidate="novalidate" method="post">
							<!--begin::Title-->
							<div class="pb-13 pt-lg-0 pt-5">
								<h3 class="font-weight-bolder text-dark font-size-h4 font-size-h1-lg text-center"><?php echo $infopt->nama_info_pt; ?></h3>
							</div>
							<!--begin::Title-->
							...
							<div class="form-group">
								...
								<input class="form-control form-control-solid h-auto py-6 px-6 rounded-lg" type="password" name="password" autocomplete="off" placeholder="Masukan password anda" />
							</div>
							<!--end::Form group-->
							<!--begin::Action-->
							<div class="pb-lg-0 pb-5">
								<button type="submit" name="submit" value="submit" class="btn btn-primary font-weight-bolder font-size-h6 px-8 py-4 my-3 mr-3">Masuk</button>
								<a href="<?= base_url('login/register/') ?>" class="btn btn-light-primary font-weight-bolder px-8 py-4 my-3 font-size-lg">
