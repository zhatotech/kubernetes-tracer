	...
	<div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
		...
		<div class="d-flex align-items-center flex-wrap mr-1">
			...
			<div class="d-flex align-items-baseline flex-wrap mr-5">
				<!--begin::Page Title-->
				<h5 class="text-dark font-weight-bold my-1 mr-5">Mahasiswa</h5>
				<!--end::Page Title-->
				<!--begin::Breadcrumb-->
			...
			<div class="card-header">
				<div class="row">
					<div class="col">
						...
						<span class="text-muted" style="margin-left: 5px;">Daftar Mahasiswa </span>
					</div>
						...
						<div class="row">
							<div class="col-md-4">
								<div class="input-icon">
									<input type="text" class="form-control" placeholder="Cari Mahasiswa..." <?php if (!empty($post['string'])) : ?> value="<?php echo $post['string'] ?>" <?php endif ?> />
									<span>
							...
							<div class="col-md-4">
								<div class="input-icon">
									<select name="nama_program_studi" class="form-control">
										<?php if (!empty($post['nama_program_studi'])): ?>
											<option value="<?php echo $post['nama_program_studi'] ?>"><?php echo $post['nama_program_studi'] ?></option>
										<?php endif ?>
										<?php foreach ($allprodi as $data): ?>
											<option value="<?php echo $data->nama_jenjang_pendidikan.' '.$data->nama_program_studi ?>"><?php echo $data->nama_jenjang_pendidikan.' '.$data->nama_program_studi ?></option>
										<?php endforeach ?>
									</select>
					...
					<table class="table">
						...
						<?php foreach ($hasil as $data): ?>
							<tr>
								...
								<td><?php echo $data['id_periode_masuk'] ?></td>
								<td>
									<a href="<?php echo base_url('mahasiswa/detail/'.$data['id_alumni']) ?>" class="label label-lg label-light-primary label-inline font-weight-bold py-4">
										Detail
									</a>
								</td>
							</tr>
