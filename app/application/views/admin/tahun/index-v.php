	...
	<div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
		...
		<div class="d-flex align-items-center flex-wrap mr-1">
			...
			<div class="d-flex align-items-baseline flex-wrap mr-5">
				<!--begin::Page Title-->
				<h5 class="text-dark font-weight-bold my-1 mr-5">Tahun</h5>
				<!--end::Page Title-->
				<!--begin::Breadcrumb-->
				<ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
					<li class="breadcrumb-item">
						<a href="<?php echo base_url('tahun/') ?>" class="text-muted">Detail</a>
					</li>
				</ul>
				<!--end::Breadcrumb-->
			</div>
		...
		<div class="card">
			...
			<div class="card-body">
				<div class="table-responsive">
					<form action="<?php echo base_url('tahun/index') ?>" method="post">
						<div class="row">
							<div class="col-md-11">
								<div class="input-icon">
									<input type="text" class="form-control" placeholder="Cari Tahun..." <?php if (!empty($post['string'])) : ?> value="<?php echo $post['string'] ?>" <?php endif ?> />
									<span>
					...
					<table class="table">
						...
						<?php foreach ($hasil as $data): ?>
							<tr>
								...
								<td>
									<a href="<?php echo base_url('tahun/detail/'.$data['id_tahun']) ?>" class="label label-lg label-light-primary label-inline font-weight-bold py-4">
										Detail
									</a>
								</td>
							</tr>
