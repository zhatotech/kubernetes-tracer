...
<body id="kt_body" class="header-fixed header-mobile-fixed subheader-enabled subheader-fixed aside-enabled aside-fixed aside-minimize-hoverable page-loading">
	...
	<div id="kt_header_mobile" class="header-mobile align-items-center header-mobile-fixed">
		...
		<a href="<?php echo base_url('dashboard') ?>">
			<img alt="Logo" src="<?php echo base_url('assets/img/lembaga/'.$infopt->logo_pt) ?>" width="150px" />
		</a>
		<!--end::Logo-->
		<!--begin::Toolbar-->
			...
			<div class="aside aside-left aside-fixed d-flex flex-column flex-row-auto" id="kt_aside">
				...
				<div class="brand flex-column-auto" id="kt_brand">
					...
					<a href="<?php echo base_url('dashboard') ?>" class="brand-logo">
						<img alt="Logo" src="<?php echo base_url('assets/img/lembaga/'.$infopt->logo_pt) ?>" width="100%" />
					</a>
					<!--end::Logo-->
					<!--begin::Toggle-->
					...
					<div class="container-fluid d-flex align-items-stretch justify-content-between">
						...
						<div class="topbar">
							...
							<div class="topbar-item" data-offset="10px,0px">
								<a href="<?= base_url('dashboard')?>"><div class="btn btn-icon btn-clean btn-lg mr-1 pulse pulse-primary" data-container="body" data-toggle="tooltip" data-placement="bottom" title="Home">
							...
							<!-- begin::peserta -->
							<div class="topbar-item" data-offset="10px,0px">
								<a href="<?= base_url('peserta') ?>"><div class="btn btn-icon btn-clean btn-lg mr-1 pulse pulse-primary" data-container="body" data-toggle="tooltip" data-placement="bottom" title="Info peserta">
									<span class="svg-icon svg-icon-xl svg-icon-primary">
										<!--begin::Svg Icon | path:<?php echo base_url('assets/metronic_v7.1.8/theme/html/demo1/dist/') ?>assets/media/svg/icons/Code/Compiling.svg-->
										<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
											<g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
							...
							<!-- begin::transfer bank -->
							<div class="topbar-item" data-offset="10px,0px">
								<div class="btn btn-icon btn-clean btn-lg mr-1 pulse pulse-primary" data-container="body" data-toggle="tooltip" data-placement="bottom" title="Transfer bank">
									<span class="svg-icon svg-icon-xl svg-icon-primary">
										<!--begin::Svg Icon | path:<?php echo base_url('assets/metronic_v7.1.8/theme/html/demo1/dist/') ?>assets/media/svg/icons/Code/Compiling.svg-->
										<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
											<g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
							...
							<!-- begin::kelas tes -->
							<div class="topbar-item" data-offset="10px,0px">
								<div class="btn btn-icon btn-clean btn-lg mr-1 pulse pulse-primary" data-container="body" data-toggle="tooltip" data-placement="bottom" title="Kelas tes">
									<span class="svg-icon svg-icon-xl svg-icon-primary">
										<!--begin::Svg Icon | path:<?php echo base_url('assets/metronic_v7.1.8/theme/html/demo1/dist/') ?>assets/media/svg/icons/Code/Compiling.svg-->
										<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
											<g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
							...
							<!-- begin::history -->
							<div class="topbar-item" data-offset="10px,0px">
								<div class="btn btn-icon btn-clean btn-lg mr-1 pulse pulse-primary" data-container="body" data-toggle="tooltip" data-placement="bottom" title="History">
									<span class="svg-icon svg-icon-xl svg-icon-primary">
										<!--begin::Svg Icon | path:<?php echo base_url('assets/metronic_v7.1.8/theme/html/demo1/dist/') ?>assets/media/svg/icons/Code/Compiling.svg-->
										<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
											<g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
							...
							<!-- begin::settings -->
							<div class="topbar-item" data-offset="10px,0px">
								<a href="<?= base_url('setting') ?>"><div class="btn btn-icon btn-clean btn-lg mr-1 pulse pulse-primary" data-container="body" data-toggle="tooltip" data-placement="bottom" title="Pengaturan">
