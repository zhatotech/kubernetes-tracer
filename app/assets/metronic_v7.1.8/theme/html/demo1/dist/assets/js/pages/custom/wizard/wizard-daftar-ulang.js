            ...
            _formEl, {
                fields: {
                    ...
                    nik: {
                        validators: {
                            notEmpty: {
                                message: 'Harap masukkan Nomor Induk Kependudukan (NIK) anda!'
                            }
                        }
                    },
                    jk: {
                    ...
                    agama: {
                        validators: {
                            notEmpty: {
                                message: 'Harap pilih Agama anda!'
                            }
                        }
                    },
                    nohp: {
            ...
            _formEl, {
                fields: {
                    nm_ayah: {
                        validators: {
                            notEmpty: {
                                message: 'Harap masukkan Nama Ayah anda!'
                            },
                        }
                    },
                    nik_ayah: {
                        validators: {
                            notEmpty: {
                                message: 'Harap masukkan Nomor Induk Kependudukan (NIK) Ayah anda!'
                            },
                        }
                    },
                    nm_ibu_kandung: {
                        validators: {
                            notEmpty: {
                                message: 'Harap masukkan Nama Ibu Kandung anda!'
                            },
                        }
                    },
                    nik_ibu_kandung: {
                        validators: {
                            notEmpty: {
                                message: 'Harap masukkan Nomor Induk Kependudukan (NIK) Ibu Kandung anda!'
                            },
                        }
                    },
                },
